...
public class Main {
	...
	public static void main(String[] args) {
		...
		CalculateScore test = new CalculateScore(matchType, scoreString);
		...
		CalculateScore odi = new CalculateScore(matchType, scoreString);
		...
		CalculateScore t20 = new CalculateScore(matchType, scoreString);
